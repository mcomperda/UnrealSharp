...
#include "ManagedTypes/Functions/CSFunction_NoParams.h"
#include "ManagedTypes/Functions/CSFunction_Params.h"
...
{
	FProperty* NewParam = FCSPropertyFactoryUtils::CreateAndAssignProperty(Function, PropertyMetaData);

	if (UBlueprintGeneratedClass* Class = Cast<UBlueprintGeneratedClass>(Function->GetOuter()))
	{
		FCSPropertyFactoryUtils::TryAddPropertyAsFieldNotify(PropertyMetaData, Class);
	}
