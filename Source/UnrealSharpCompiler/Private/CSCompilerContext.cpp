...
#include "ManagedTypeBuilders/CSSimpleConstructionScriptBuilder.h"
#include "ManagedTypeInfo/CSClassInfo.h"
#include "ManagedTypes/CSBlueprint.h"
#include "ManagedTypes/CSSkeletonClass.h"
...
void FCSCompilerContext::CreateClassVariablesFromBlueprint()
{
	...
	FCSPropertyFactoryUtils::CreateAndAssignProperties(NewClass, Properties, [this](const FProperty* NewProperty)
	{
		FName PropertyName = NewProperty->GetFName();
		FGuid PropertyGuid = UCSPropertyFactory::ConstructGUIDFromName(PropertyName);
