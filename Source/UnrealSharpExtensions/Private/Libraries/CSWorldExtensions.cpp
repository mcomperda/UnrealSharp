#include "Libraries/CSWorldExtensions.h"

#include "UnrealSharpCore.h"
#include "UnrealSharpExtensions.h"
...
FURL UCSWorldExtensions::WorldURL(const UObject* WorldContextObject)
{
	...
	{
		UE_LOG(LogUnrealSharpExtensions, Error, TEXT("Invalid world context object"));
		return nullptr;
	}
	...
	if (!IsValid(World))
	{
		UE_LOG(LogUnrealSharpExtensions, Error, TEXT("Failed to get world from context object"));
		return nullptr;
	}
...
AActor* UCSWorldExtensions::SpawnActor_Internal(const UObject* WorldContextObject, const TSubclassOf<AActor>& Class, const FTransform& Transform, const FCSSpawnActorParameters& SpawnParameters, bool bDeferConstruction)
{
	...
	{
		UE_LOG(LogUnrealSharpExtensions, Error, TEXT("Invalid world context object or class"));
		return nullptr;
	}
