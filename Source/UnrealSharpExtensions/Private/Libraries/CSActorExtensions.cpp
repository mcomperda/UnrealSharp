#include "Libraries/CSActorExtensions.h"
...
UActorComponent* UCSActorExtensions::GetComponentTemplate(const AActor* Actor, FName ComponentName)
{
	...
	UE_LOG(LogUnrealSharpExtensions, Error, TEXT("Component %s not found in actor %s. Should not happen to DefaultComponents"), *ComponentName.ToString(), *Actor->GetName());
	return nullptr;
}
